        ...
        <section className="hidden md:flex md:w-1/2 bg-primary relative overflow-hidden flex-col justify-between p-12">
          ...
          <div className="relative z-10">
            <Link href="/" className="flex items-center gap-2 mb-12 hover:opacity-80 transition-opacity w-fit">
              ...
              <span className="text-2xl font-black font-headline text-on-primary tracking-tighter">LearnLoop</span>
            </Link>
            
            <h1 className="text-5xl lg:text-7xl font-bold font-headline text-on-primary leading-tight tracking-tight max-w-lg">
              Level up your <span className="text-primary-fixed">intellect.</span>
            </h1>
            <p className="mt-6 text-xl text-on-primary/80 font-medium max-w-md">
          ...
          <div className="relative z-10 mt-auto">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/10 max-w-sm shadow-glass">
              <div className="flex items-center gap-4 mb-4">
                ...
                />
                <div>
                  <p className="text-on-primary font-bold font-headline">Sarah Chen</p>
                  <p className="text-on-primary/60 text-sm">Product Designer</p>
                </div>
              </div>
              <p className="text-on-primary/90 italic text-sm leading-relaxed">
        ...
        <section className="flex-1 flex flex-col justify-center items-center px-6 py-12 md:px-16 bg-surface">
          <div className="w-full max-w-md">
            ...
            <div className="mb-8">
              ...
              <p className="text-on-surface-variant font-medium">Don't have an account? <Link href="/register" className="text-primary hover:underline underline-offset-4 font-bold">Sign up here</Link></p>
            </div>
            
            {/* Social Logins */}
            <div className="grid grid-cols-2 gap-4 mb-8">
              <button className="flex items-center justify-center gap-3 py-3 px-4 rounded-xl bg-surface-container-lowest border border-outline-variant/20 hover:bg-surface-container-low shadow-sm hover:shadow transition-all duration-200">
            ...
            <div className="relative flex items-center mb-8">
              ...
              <span className="flex-shrink mx-4 text-xs font-bold text-outline uppercase tracking-widest">Or login with email</span>
              <div className="flex-grow border-t border-outline-variant/20"></div>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              <div>
                <label className="block text-xs font-bold text-on-surface-variant uppercase tracking-wider mb-2 ml-1" htmlFor="login-email">Email Address</label>
                <input 
                  type="email" 
                  id="login-email" 
                  value={email}
              ...
              <div>
                <div className="flex justify-between items-center mb-2 ml-1">
                   <label className="block text-xs font-bold text-on-surface-variant uppercase tracking-wider" htmlFor="login-password">Password</label>
              ...
              <div className="pt-4 relative">
                ...
                <button 
                  disabled={loading}
                  type="submit" 
                  className="w-full bg-primary text-on-primary py-4 px-8 rounded-full font-bold text-lg shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 active:scale-[0.98] transition-all duration-200 flex justify-center items-center gap-3"
                >
