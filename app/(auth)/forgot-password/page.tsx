      ...
      <main className="flex-grow flex items-center justify-center px-6 py-12">
        ...
        <div className="w-full max-w-md bg-white p-8 md:p-12 rounded-[2rem] shadow-premium relative overflow-hidden border border-surface-container">
          ...
          <form className="space-y-6 relative z-10">
            ...
            <button type="submit" className="w-full py-4 px-6 bg-primary text-primary-on font-bold rounded-xl text-lg hover:brightness-110 active:scale-95 transition-all shadow-md shadow-primary/20">
              Send Reset Link
            </button>
          </form>

          {/* Confirmation State Message (Visually hidden initially in real app, shown here to match design) */}
      ...
      <footer className="w-full py-12 px-6 max-w-7xl mx-auto border-t border-surface-container">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-surface-variant text-sm font-medium">
            © 2024 LearnLoop AI. Elevate your intellect.
          </div>
