    ...
    <div className="bg-surface text-surface-on min-h-screen">
      ...
      <aside className="w-64 fixed left-0 top-0 h-screen bg-white border-r border-surface-container flex flex-col pt-8 pb-6 gap-2 z-50 transition-all duration-300 ease-in-out shadow-sm">
        <div className="px-6 mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[10px] font-bold text-surface-variant uppercase tracking-widest mt-0.5">System Overview</p>
            </div>
          </div>
        </div>
        ...
        <nav className="flex-1 space-y-2 overflow-y-auto px-4 mt-4">
          ...
          <Link href="/admin/users" className="text-surface-variant hover:text-surface-on px-4 py-3 flex items-center gap-3 font-headline text-sm font-bold hover:bg-surface rounded-xl transition-all duration-200 group">
            <span className="material-symbols-outlined group-hover:text-secondary transition-colors">group</span> Users
          </Link>
          <Link href="/studio" className="text-surface-variant hover:text-surface-on px-4 py-3 flex items-center gap-3 font-headline text-sm font-bold hover:bg-surface rounded-xl transition-all duration-200 group">
             <span className="material-symbols-outlined group-hover:text-tertiary transition-colors">psychology</span> AI Controls
          </Link>
          <Link href="#" className="text-surface-variant hover:text-surface-on px-4 py-3 flex items-center gap-3 font-headline text-sm font-bold hover:bg-surface rounded-xl transition-all duration-200 group">
            <span className="material-symbols-outlined group-hover:text-green-500 transition-colors">payments</span> Billing
          </Link>
          <Link href="/admin/moderation" className="text-surface-variant hover:text-surface-on px-4 py-3 flex items-center gap-3 font-headline text-sm font-bold hover:bg-surface rounded-xl transition-all duration-200 group">
        ...
        <div className="px-6 mt-auto space-y-4 pt-6 border-t border-surface-container">
          <button className="w-full bg-surface border border-surface-container text-surface-on py-3 rounded-xl font-bold text-sm hover:bg-surface-bright active:scale-95 transition-all outline-none shadow-sm flex justify-center items-center gap-2">
             <span className="material-symbols-outlined text-lg">download</span> Export Data
          </button>
          <div className="pt-2 flex flex-col gap-1">
            <Link href="/legal" className="text-surface-variant px-2 py-2 flex items-center gap-3 font-headline text-xs font-bold hover:bg-surface rounded-lg transition-all">
              <span className="material-symbols-outlined text-[1rem]">policy</span> Legal
            </Link>
            <Link href="/support" className="text-surface-variant px-2 py-2 flex items-center gap-3 font-headline text-xs font-bold hover:bg-surface rounded-lg transition-all">
      ...
      <main className="ml-64 p-10 lg:p-12 max-w-[1600px] mx-auto min-h-screen">
        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6">
          <div>
            <h2 className="text-4xl font-black font-headline text-surface-on tracking-tight">System Insights</h2>
            <p className="text-surface-variant font-medium mt-1">Real-time platform health and performance metrics</p>
          </div>
          
          <div className="flex items-center gap-5">
            <button className="w-12 h-12 bg-white border border-surface-container rounded-full text-surface-variant hover:text-primary hover:border-primary/30 transition-colors shadow-sm flex items-center justify-center outline-none">
            ...
            <div className="flex items-center gap-4 bg-white border border-surface-container p-2 pr-6 rounded-full shadow-sm hover:shadow-md transition-shadow cursor-pointer">
              ...
              <div className="text-left">
                <p className="text-sm font-black font-headline leading-none text-surface-on tracking-wide">LearnLoop Admin</p>
        ...
        <section className="grid grid-cols-12 gap-8 mb-16">
          ...
          <div className="col-span-12 lg:col-span-8 bg-white p-10 rounded-3xl shadow-sm border border-surface-container relative overflow-hidden group">
            ...
            <div className="relative z-10 h-full flex flex-col justify-between">
              <div className="flex justify-between items-start mb-8">
                <div>
                  <p className="text-surface-variant text-sm font-black uppercase tracking-widest mb-2 font-headline">Total Revenue</p>
                  <h3 className="text-5xl font-black font-headline text-surface-on">$142,850.00</h3>
                </div>
          ...
          <div className="col-span-12 md:col-span-6 lg:col-span-4 bg-white p-8 rounded-3xl border border-surface-container shadow-sm group hover:border-surface-variant transition-colors">
            <div className="flex items-center justify-between mb-8">
              <h4 className="font-black font-headline text-surface-on text-xl">Quiz Engagement</h4>
            ...
            <div className="space-y-8">
              <div>
                <div className="flex justify-between text-sm font-bold mb-3 text-surface-on">
          ...
          <div className="col-span-12 lg:col-span-8 bg-surface border border-surface-container p-8 rounded-3xl flex flex-col md:flex-row items-center justify-between gap-10 shadow-sm">
            <div className="flex-1">
              <h4 className="text-2xl font-black font-headline text-surface-on mb-4">Topic Popularity Index</h4>
              <p className="text-surface-variant font-medium mb-8 text-lg leading-relaxed max-w-lg">AI & Machine Learning courses are currently trending +40% higher than last month.</p>
              <div className="flex flex-wrap gap-3">
                ...
                <span className="px-5 py-2.5 bg-white border border-surface-container text-surface-on text-xs font-black rounded-full uppercase tracking-wider shadow-sm hover:border-primary transition-colors cursor-pointer">Neural Nets</span>
                <span className="px-5 py-2.5 bg-white border border-surface-container text-surface-on text-xs font-black rounded-full uppercase tracking-wider shadow-sm hover:border-primary transition-colors cursor-pointer">Python Mastery</span>
              </div>
            </div>
        ...
        <section className="bg-white rounded-[2rem] shadow-sm border border-surface-container overflow-hidden mb-16">
          <div className="px-10 py-8 border-b border-surface-container flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <h3 className="text-3xl font-black tracking-tight font-headline text-surface-on">User Management</h3>
            
            <div className="flex items-center gap-4 w-full md:w-auto">
              <div className="relative w-full md:w-auto">
                <span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-surface-variant">search</span>
                <input 
                  type="text" 
                  value={searchQuery}
              ...
              <button className="flex items-center gap-2 px-6 py-3 border border-surface-container bg-surface rounded-full text-surface-on text-sm font-bold hover:bg-surface-bright active:scale-95 transition-all outline-none">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse min-w-[800px]">
              <thead className="bg-surface/50 border-b border-surface-container">
                <tr>
                  <th className="px-10 py-5 text-xs font-black text-surface-variant uppercase tracking-widest">User</th>
                  <th className="px-10 py-5 text-xs font-black text-surface-variant uppercase tracking-widest">Status</th>
                  <th className="px-10 py-5 text-xs font-black text-surface-variant uppercase tracking-widest">Experience (XP)</th>
                  <th className="px-10 py-5 text-xs font-black text-surface-variant uppercase tracking-widest">Board Assignment</th>
                  <th className="px-10 py-5 text-xs font-black text-surface-variant uppercase tracking-widest text-center">Actions</th>
                </tr>
              </thead>
                  ...
                  <tr key={idx} className="hover:bg-surface/50 transition-colors group">
                    <td className="px-10 py-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="font-bold text-surface-on font-headline">{user.name}</p>
                          <p className="text-xs text-surface-variant font-medium mt-1">{user.email}</p>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="px-10 py-6 text-sm font-bold text-surface-on">{user.department}</td>
                    <td className="px-10 py-6 text-center">
                      <button className="text-surface-variant hover:text-primary hover:bg-primary/5 p-2 rounded-full transition-colors outline-none cursor-pointer">
          ...
          <div className="px-10 py-6 bg-surface flex items-center justify-between border-t border-surface-container">
            <p className="text-sm font-bold text-surface-variant">Showing 3 of 12,402 students</p>
            <div className="flex gap-3">
              <button className="w-10 h-10 rounded-full bg-white border border-surface-container flex items-center justify-center text-surface-variant hover:text-primary transition-colors shadow-sm active:scale-95 outline-none">
              ...
              <button className="w-10 h-10 rounded-full bg-white border border-surface-container flex items-center justify-center text-surface-on text-sm font-bold shadow-sm hover:border-primary/50 transition-colors active:scale-95 outline-none font-headline">2</button>
              <button className="w-10 h-10 rounded-full bg-white border border-surface-container flex items-center justify-center text-surface-variant hover:text-primary transition-colors shadow-sm active:scale-95 outline-none">
        ...
        <section className="mb-12">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-6">
            <h3 className="text-3xl font-black font-headline tracking-tight text-surface-on">Content Inventory</h3>
            <button className="flex items-center justify-center gap-2 px-8 py-4 bg-primary text-primary-on rounded-full font-bold shadow-premium hover:shadow-lg hover:brightness-110 active:scale-95 transition-all tracking-wide outline-none">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-3xl border border-surface-container border-t-[8px] border-t-primary flex flex-col shadow-sm hover:shadow-md transition-shadow group">
              <div className="flex justify-between items-start mb-6">
                ...
                <span className="text-[10px] font-black text-surface-variant uppercase tracking-widest bg-surface px-2.5 py-1 rounded-md border border-surface-container">14 Quizzes</span>
              </div>
              <h4 className="text-xl font-black font-headline mb-3 text-surface-on">Advanced React Hooks</h4>
              <p className="text-sm font-medium text-surface-variant mb-10 leading-relaxed flex-1">Deep dive into useEffect, useMemo, and custom hooks architecture.</p>
              ...
              <div className="flex items-center justify-between pt-5 border-t border-surface-container mt-auto">
                ...
                <button className="text-xs font-black uppercase tracking-widest text-surface-variant hover:text-primary transition-colors bg-surface hover:bg-primary/5 px-3 py-1.5 rounded-lg border border-transparent hover:border-primary/20">Edit</button>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-3xl border border-surface-container border-t-[8px] border-t-secondary flex flex-col shadow-sm hover:shadow-md transition-shadow group">
              <div className="flex justify-between items-start mb-6">
                ...
                <span className="text-[10px] font-black text-surface-variant uppercase tracking-widest bg-surface px-2.5 py-1 rounded-md border border-surface-container">8 Quizzes</span>
              </div>
              <h4 className="text-xl font-black font-headline mb-3 text-surface-on">UI/UX Psychology</h4>
              <p className="text-sm font-medium text-surface-variant mb-10 leading-relaxed flex-1">Understanding cognitive load and gestalt principles in design.</p>
              ...
              <div className="flex items-center justify-between pt-5 border-t border-surface-container mt-auto">
                ...
                <button className="text-xs font-black uppercase tracking-widest text-surface-variant hover:text-secondary transition-colors bg-surface hover:bg-secondary/5 px-3 py-1.5 rounded-lg border border-transparent hover:border-secondary/20">Edit</button>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-3xl border border-surface-container border-t-[8px] border-t-tertiary flex flex-col shadow-sm hover:shadow-md transition-shadow group">
              <div className="flex justify-between items-start mb-6">
                ...
                <span className="text-[10px] font-black text-surface-variant uppercase tracking-widest bg-surface px-2.5 py-1 rounded-md border border-surface-container">22 Quizzes</span>
              </div>
              <h4 className="text-xl font-black font-headline mb-3 text-surface-on">Data Science Fundamentals</h4>
              <p className="text-sm font-medium text-surface-variant mb-10 leading-relaxed flex-1">Linear regression, probability theory, and clean data cleaning.</p>
              ...
              <div className="flex items-center justify-between pt-5 border-t border-surface-container mt-auto">
                ...
                <button className="text-xs font-black uppercase tracking-widest text-surface-variant hover:text-tertiary transition-colors bg-surface hover:bg-tertiary/5 px-3 py-1.5 rounded-lg border border-transparent hover:border-tertiary/20">Edit</button>
              </div>
            </div>
