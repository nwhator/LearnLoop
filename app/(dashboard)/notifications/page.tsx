    ...
    <div className="bg-surface text-on-surface min-h-screen">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-xl shadow-sm flex justify-between items-center px-6 h-16 border-b border-surface-container/50">
        <div className="flex items-center gap-8">
          ...
          <div className="hidden md:flex items-center gap-6">
            <Link href="/dashboard" className="text-on-surface-variant font-medium hover:text-primary transition-colors px-3 py-1 rounded-md font-headline font-bold">Explore</Link>
            <Link href="/library" className="text-on-surface-variant font-medium hover:text-primary transition-colors px-3 py-1 rounded-md font-headline font-bold">Courses</Link>
          </div>
        </div>
        <div className="flex items-center gap-4">
          <div className="flex items-center bg-surface-container rounded-full px-4 py-1.5 shadow-inner">
            ...
            <span className="ml-1 font-bold text-on-surface">{xp} XP</span>
          </div>
          <button className="material-symbols-outlined p-2 text-on-surface-variant hover:bg-surface-container rounded-full transition-colors active:scale-95 group">
      ...
      <aside className="h-screen w-64 fixed left-0 top-0 pt-20 flex-col border-r border-surface-container bg-surface-bright hidden md:flex z-40 pb-6">
        <div className="px-6 mb-8 mt-2">
          <div className="flex flex-col items-center gap-3 p-4 bg-surface rounded-2xl border border-surface-container shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="text-center">
              ...
              <p className="text-[10px] uppercase tracking-widest text-on-surface-variant font-bold mt-1">Level {level} Architect</p>
            </div>
          </div>
        </div>
        
        <nav className="flex-grow space-y-1 overflow-y-auto px-2">
            <Link href="/dashboard" className="flex items-center gap-3 text-on-surface-variant px-4 py-3.5 mx-2 hover:bg-surface-container rounded-full transition-all text-sm font-semibold">
                <span className="material-symbols-outlined">dashboard</span> Dashboard
            </Link>
            <Link href="/library" className="flex items-center gap-3 text-on-surface-variant px-4 py-3.5 mx-2 hover:bg-surface-container rounded-full transition-all text-sm font-semibold">
                <span className="material-symbols-outlined">local_library</span> Library
            </Link>
            <Link href="/leaderboard" className="flex items-center gap-3 text-on-surface-variant px-4 py-3.5 mx-2 hover:bg-surface-container rounded-full transition-all text-sm font-semibold">
                <span className="material-symbols-outlined">leaderboard</span> Leaderboard
            </Link>
            <Link href="/missions" className="flex items-center gap-3 text-on-surface-variant px-4 py-3.5 mx-2 hover:bg-surface-container rounded-full transition-all text-sm font-semibold">
        ...
        <div className="px-4 mt-auto space-y-2 border-t border-surface-container pt-4">
            <button className="w-full bg-primary text-on-primary font-bold py-3.5 rounded-full shadow-md hover:brightness-110 transition-all active:scale-95 text-sm">
                Start Daily Quiz
            </button>
            <Link href="/settings" className="flex items-center justify-center gap-2 text-on-surface-variant py-2.5 rounded-full hover:bg-surface-container transition-all text-xs font-semibold">
      ...
      <main className="md:ml-64 pt-28 px-6 pb-12 min-h-screen">
        <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
                <div>
                    <h1 className="text-4xl font-black font-headline tracking-tight text-on-surface mb-2">Inbox</h1>
                    <p className="text-on-surface-variant font-medium text-lg">Stay updated with your learning journey and social circle.</p>
                </div>
            ...
            <div className="flex gap-2 p-1.5 bg-surface-container border border-surface-container-high rounded-[1rem] mb-8 w-fit shadow-inner overflow-x-auto no-scrollbar max-w-full">
                ...
                <button className="px-6 py-2.5 text-on-surface-variant font-semibold hover:text-on-surface transition-all tracking-wide text-sm whitespace-nowrap">Social</button>
                <button className="px-6 py-2.5 text-on-surface-variant font-semibold hover:text-on-surface transition-all tracking-wide text-sm whitespace-nowrap">Achievements</button>
                <button className="px-6 py-2.5 text-on-surface-variant font-semibold hover:text-on-surface transition-all tracking-wide text-sm whitespace-nowrap">System</button>
            </div>
            ...
            <div className="space-y-4">
                    ...
                    <div className="flex gap-5">
                        ...
                        <div className="flex-1">
                            <div className="flex justify-between items-start mb-1">
                                <h3 className="font-bold text-lg text-on-surface font-headline">New Friend Challenge!</h3>
                                <span className="text-xs font-bold text-primary bg-primary/5 px-2 py-1 rounded-md uppercase tracking-wider">Just Now</span>
                            </div>
                            <p className="text-on-surface-variant mb-5 font-medium">Sarah Jenkins challenged you to a 'Python Basics' duel. The winner gets 500 XP!</p>
                            <div className="flex flex-wrap gap-3">
                                <button className="px-6 py-2.5 bg-primary text-on-primary text-sm font-bold rounded-full hover:brightness-110 shadow-sm active:scale-95 transition-all">Accept Challenge</button>
                                <button className="px-6 py-2.5 bg-surface text-on-surface-variant border border-surface-container text-sm font-bold rounded-full hover:bg-surface-bright hover:shadow-inner transition-all">Decline</button>
                            </div>
                        </div>
                ...
                <div className="group relative bg-white border border-surface-container p-6 rounded-2xl hover:shadow-md hover:border-tertiary/20 transition-all duration-300 border-l-[6px] border-l-tertiary">
                    <div className="flex gap-5">
                        ...
                        <div className="flex-1">
                            <div className="flex justify-between items-start mb-1">
                                <h3 className="font-bold text-lg text-on-surface font-headline">Badge Unlocked: Night Owl</h3>
                                <span className="text-[11px] font-bold text-on-surface-variant uppercase tracking-wider">3h ago</span>
                            </div>
                            <p className="text-on-surface-variant font-medium">You've completed 5 lessons after 10 PM. You're part of the elite 5%!</p>
                        </div>
                ...
                <div className="group relative bg-white border border-surface-container p-6 rounded-2xl hover:shadow-md hover:border-secondary/20 transition-all duration-300">
                    <div className="flex gap-5">
                        ...
                        <div className="flex-1">
                            <div className="flex justify-between items-start mb-1">
                                <h3 className="font-bold text-lg text-on-surface font-headline">Leaderboard Shift</h3>
                                <span className="text-[11px] font-bold text-on-surface-variant uppercase tracking-wider">5h ago</span>
                            </div>
                            <p className="text-on-surface-variant font-medium">Oh no! Marcus D. just overtook you in the Diamond League. Get 200 XP to reclaim your spot!</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="group relative bg-white border border-surface-container p-6 rounded-2xl hover:shadow-md hover:border-orange-500/20 transition-all duration-300">
                    <div className="flex gap-5">
                        ...
                        <div className="flex-1">
                            <div className="flex justify-between items-start mb-1">
                                <h3 className="font-bold text-lg text-on-surface font-headline">15-Day Streak!</h3>
                                <span className="text-[11px] font-bold text-on-surface-variant uppercase tracking-wider">1d ago</span>
                            </div>
                            <p className="text-on-surface-variant font-medium">Incredible consistency, Alex! Keep it going to reach your monthly goal.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="group relative bg-white border border-surface-container p-6 rounded-2xl hover:shadow-md transition-all duration-300 opacity-80 hover:opacity-100">
                    <div className="flex gap-5">
                        <div className="flex-shrink-0 w-12 h-12 rounded-full bg-surface flex items-center justify-center text-on-surface border border-surface-container shadow-sm">
                            <span className="material-symbols-outlined text-xl">rocket_launch</span>
                        </div>
                        <div className="flex-1">
                            <div className="flex justify-between items-start mb-1">
                                <h3 className="font-bold text-lg text-on-surface font-headline">New Feature: Study Groups</h3>
                                <span className="text-[11px] font-bold text-on-surface-variant uppercase tracking-wider">Yesterday</span>
                            </div>
                            <p className="text-on-surface-variant font-medium">You can now create private study groups with your classmates and share resources in real-time.</p>
                        </div>
                    </div>
                </div>
