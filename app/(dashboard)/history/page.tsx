      ...
      <main className="flex-1 lg:ml-72 min-h-screen">
        ...
        <div className="p-8 lg:p-12 mt-20 max-w-7xl mx-auto w-full space-y-12">
          ...
          <header className="mb-12">
            <h1 className="text-5xl font-black font-headline text-surface-on tracking-tighter mb-4">The Scholar's Path</h1>
            <p className="text-xl text-surface-variant font-medium opacity-80">Chronicle of your evolution through the arena of knowledge.</p>
          </header>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10">
            ...
            <section className="md:col-span-8 bg-white border border-surface-container rounded-[3rem] p-10 shadow-premium group">
              <div className="flex justify-between items-center mb-10">
                <div>
                  <h2 className="text-2xl font-black font-headline text-surface-on tracking-tight">Experience Trajectory</h2>
                  <p className="text-sm text-surface-variant font-black uppercase tracking-widest opacity-60">Neural Growth Index</p>
                </div>
              ...
              <div className="flex justify-between mt-6 text-[10px] text-surface-variant font-black uppercase tracking-widest opacity-50 px-2">
            ...
            <section className="md:col-span-4 space-y-8">
              ...
              <div className="bg-white border border-surface-container rounded-[2.5rem] p-10 shadow-sm">
                <h3 className="font-black font-headline text-xl mb-8 text-surface-on tracking-tight">Core Indices</h3>
                <div className="space-y-6">
                  {['Quizzes Resolved: 142', 'Accuracy Factor: 92%', 'Focus Duration: 48h'].map((stat) => (
                      <div key={stat} className="p-5 bg-surface rounded-2xl border border-surface-container flex items-center justify-between group hover:border-primary/30 transition-colors">
                        <span className="text-xs font-black uppercase tracking-widest text-surface-on opacity-70 group-hover:opacity-100">{stat.split(':')[0]}</span>
            ...
            <section className="md:col-span-12 lg:col-span-12 bg-white border border-surface-container rounded-[3rem] p-10 lg:p-14 shadow-sm">
              <div className="flex justify-between items-center mb-12">
                <h2 className="text-3xl font-black font-headline text-surface-on tracking-tight">Timeline of Excellence</h2>
                ...
                {[
                  ...
                  <div key={i} className="flex items-center gap-8 p-6 rounded-3xl hover:bg-surface border border-transparent hover:border-surface-container transition-all group">
                    ...
                    <div className="flex-1 flex flex-col md:flex-row md:items-center justify-between gap-4">
                      <div>
                        <h4 className="font-black font-headline text-xl text-surface-on tracking-tight">{act.title}</h4>
                        <span className="text-[10px] font-black uppercase tracking-widest text-surface-variant opacity-60">{act.type}</span>
                      </div>
                      <div className="flex items-center gap-6">
                        <span className="text-sm font-black font-headline text-surface-on bg-surface-container px-4 py-1 rounded-full">{act.result}</span>
