    ...
    <div className="bg-surface text-surface-on min-h-screen">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-xl shadow-sm flex justify-between items-center px-6 h-16 border-b border-surface-container/50">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            <button className="p-2 text-surface-variant hover:bg-surface-container rounded-full transition-colors active:scale-95">
              <span className="material-symbols-outlined">bolt</span>
            </button>
            <Link href="/subscription" className="p-2 text-surface-variant hover:bg-surface-container rounded-full transition-colors active:scale-95 group">
              <span className="material-symbols-outlined group-hover:text-tertiary">workspace_premium</span>
            </Link>
            <button className="p-2 text-surface-variant hover:bg-surface-container rounded-full transition-colors active:scale-95 group">
      ...
      <aside className="hidden md:flex flex-col h-full border-r border-surface-container bg-surface-bright w-64 fixed left-0 top-0 pt-20 z-40">
        <div className="px-6 mb-8 mt-4">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-headline text-sm font-bold text-surface-on">Alex Rivers</h3>
              <p className="text-xs text-surface-variant font-medium">Level {level} Architect</p>
            </div>
          </div>
          <Link href="/dashboard" className="w-full bg-primary text-primary-on font-bold py-3 rounded-xl hover:brightness-110 shadow-sm transition-all active:scale-95 text-sm flex justify-center">
             Start Daily Quiz
          </Link>
        </div>
        
        <nav className="flex-grow space-y-1 overflow-y-auto px-2">
          <Link href="/dashboard" className="flex items-center gap-3 text-surface-variant px-4 py-3 mx-2 hover:bg-surface-container rounded-full transition-all text-sm font-semibold">
            <span className="material-symbols-outlined">dashboard</span> Dashboard
          </Link>
          <Link href="/library" className="flex items-center gap-3 text-surface-variant px-4 py-3 mx-2 hover:bg-surface-container rounded-full transition-all text-sm font-semibold">
            <span className="material-symbols-outlined">local_library</span> Library
          </Link>
          <Link href="/leaderboard" className="flex items-center gap-3 text-surface-variant px-4 py-3 mx-2 hover:bg-surface-container rounded-full transition-all text-sm font-semibold">
            <span className="material-symbols-outlined">leaderboard</span> Leaderboard
          </Link>
          <Link href="/missions" className="flex items-center gap-3 text-surface-variant px-4 py-3 mx-2 hover:bg-surface-container rounded-full transition-all text-sm font-semibold">
            <span className="material-symbols-outlined">assignment_turned_in</span> Missions
          </Link>
          <Link href="/profile" className="flex items-center gap-3 text-surface-variant px-4 py-3 mx-2 hover:bg-surface-container rounded-full transition-all text-sm font-semibold">
            <span className="material-symbols-outlined">person</span> Profile
          </Link>
        </nav>
        
        <div className="mt-auto border-t border-surface-container pt-4 pb-8 flex flex-col gap-1 px-2">
          <Link href="/history" className="flex items-center gap-3 text-surface-variant px-4 py-2 mx-2 hover:bg-surface-container rounded-full transition-all text-xs font-semibold">
            <span className="material-symbols-outlined text-sm">history</span> History
          </Link>
          <Link href="/notifications" className="flex items-center gap-3 text-surface-variant px-4 py-2 mx-2 hover:bg-surface-container rounded-full transition-all text-xs font-semibold">
      ...
      <main className="md:ml-64 pt-28 pb-32 px-6 md:px-12 max-w-6xl mx-auto">
        ...
        <header className="mb-12">
          <h1 className="text-4xl font-black font-headline tracking-tight text-surface-on mb-2">Settings & Preferences</h1>
          <p className="text-surface-variant text-lg font-medium tracking-wide">Manage your LearnLoop experience and account security.</p>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-8 space-y-8">
                ...
                <section className="bg-white rounded-2xl p-8 border border-surface-container shadow-sm">
                    <div className="flex items-center gap-4 mb-8 border-b border-surface-container/50 pb-6">
                        ...
                        <h2 className="text-2xl font-bold font-headline text-surface-on">Account Management</h2>
                    </div>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="flex flex-col md:flex-row gap-8 items-start md:items-center p-6 bg-surface rounded-2xl border border-surface-container">
                            ...
                            <div className="flex-grow w-full">
                                <h3 className="text-xl font-bold font-headline text-surface-on mb-1">Public Profile</h3>
                                <p className="text-sm text-surface-variant mb-4 font-medium">Your avatar and name are visible to other architects.</p>
                ...
                <section className="bg-white rounded-2xl p-8 border border-surface-container shadow-sm">
                    <div className="flex items-center gap-4 mb-8 border-b border-surface-container/50 pb-6">
                        ...
                        <h2 className="text-2xl font-bold font-headline text-surface-on">Notification Preferences</h2>
                    </div>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between p-5 bg-surface border border-surface-container rounded-2xl cursor-pointer hover:border-surface-variant transition-colors" onClick={() => handleToggle('emailNotifs')}>
                            <div className="flex items-center gap-5">
                                ...
                                <div>
                                    <p className="font-bold text-surface-on">Email Notifications</p>
                        ...
                        <div className="flex items-center justify-between p-5 bg-surface border border-surface-container rounded-2xl cursor-pointer hover:border-surface-variant transition-colors" onClick={() => handleToggle('inAppAlerts')}>
                            <div className="flex items-center gap-5">
                                ...
                                <div>
                                    <p className="font-bold text-surface-on">In-App Alerts</p>
            ...
            <div className="lg:col-span-4 space-y-8">
                ...
                <section className="bg-white rounded-2xl p-6 border border-surface-container shadow-sm">
                    <h3 className="text-lg font-black font-headline mb-6 flex items-center gap-2 text-surface-on border-b border-surface-container/50 pb-4">
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="pt-5 border-t border-surface-container/50">
                            <p className="text-[10px] font-bold text-surface-variant uppercase tracking-widest mb-3">Interface Density</p>
                            <div className="flex gap-2">
                                <button className="flex-1 py-2.5 text-xs font-bold bg-primary text-primary-on rounded-xl shadow-sm">Comfortable</button>
                                <button className="flex-1 py-2.5 text-xs font-bold bg-surface hover:bg-surface-container border border-surface-container text-surface-variant rounded-xl transition-colors">Compact</button>
                            </div>
                        </div>
                    </div>
                </section>
