    ...
    <div className="bg-surface text-on-surface min-h-screen">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-xl shadow-sm flex justify-between items-center px-6 h-16">
        <div className="flex items-center gap-8">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <Link href="/community" className="text-on-surface-variant font-medium font-headline hover:bg-surface-container/50 transition-colors px-3 py-1 rounded-lg">Community</Link>
            <Link href="/support" className="text-on-surface-variant font-medium font-headline hover:bg-surface-container/50 transition-colors px-3 py-1 rounded-lg">Support</Link>
          </div>
        </div>
        <div className="flex items-center gap-4">
          ...
          <button className="material-symbols-outlined text-on-surface-variant p-2 hover:bg-surface-container rounded-full transition-all active:scale-95">settings</button>
          <div className="h-10 w-10 rounded-full border-2 border-primary-container bg-surface-container overflow-hidden flex items-center justify-center font-bold text-on-surface-variant">
             A
          </div>
        </div>
      </nav>
      ...
      <aside className="hidden lg:flex flex-col h-screen w-64 fixed left-0 top-0 pt-20 bg-surface-bright border-r border-surface-container pb-6 z-40">
        ...
        <nav className="flex-1 flex flex-col gap-1">
          <Link href="/velocity" className="text-on-surface-variant px-4 py-3 mx-2 flex items-center gap-3 font-semibold text-sm hover:bg-surface-container rounded-xl transition-all">
             <span className="material-symbols-outlined">insights</span> Analytics
          </Link>
          <Link href="/users" className="text-on-surface-variant px-4 py-3 mx-2 flex items-center gap-3 font-semibold text-sm hover:bg-surface-container rounded-xl transition-all">
          ...
          <Link href="/billing" className="text-on-surface-variant px-4 py-3 mx-2 flex items-center gap-3 font-semibold text-sm hover:bg-surface-container rounded-xl transition-all">
             <span className="material-symbols-outlined">payments</span> Billing
          </Link>
        </nav>
        <div className="px-4 mt-auto space-y-4">
          <button className="w-full bg-primary text-on-primary font-bold py-3 rounded-full shadow-md hover:brightness-110 transition-all font-headline text-sm">
            Export Data
          </button>
        </div>
      </aside>
      ...
      <main className="lg:ml-64 pt-24 pb-32 px-6 md:px-10 max-w-7xl mx-auto">
        <header className="mb-12">
          <h1 className="text-4xl font-headline font-extrabold tracking-tight text-on-surface mb-2">AI Generation Controls</h1>
          <p className="text-on-surface-variant max-w-2xl text-lg">Tailor the machine learning algorithms to fit your curriculum requirements. Adjust complexity, depth, and output formats in real-time.</p>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <section className="md:col-span-8 bg-white border border-surface-container p-8 rounded-2xl shadow-premium">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                <h3 className="font-headline text-xl font-bold text-on-surface">Generation Parameters</h3>
                <p className="text-on-surface-variant text-sm mt-0.5">Fine-tune the complexity of generated items</p>
              </div>
            </div>
            ...
            <div className="space-y-10">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <label className="font-headline font-bold text-on-surface">Cognitive Complexity</label>
                ...
                />
                <div className="flex justify-between text-[10px] font-bold text-on-surface-variant uppercase tracking-widest mt-2">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <label className="font-headline font-bold text-on-surface">Batch Question Count</label>
              ...
              <div className="pt-6 border-t border-surface-container/50">
                <label className="font-headline font-bold text-on-surface block mb-6">Supported Formats</label>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <label className="flex items-center p-4 rounded-xl bg-surface border border-surface-container hover:border-primary/50 transition-all cursor-pointer shadow-sm">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-bold text-on-surface">MCQ</p>
                      <p className="text-[10px] text-on-surface-variant mt-0.5">Multiple Choice</p>
                    </div>
                  ...
                  <label className="flex items-center p-4 rounded-xl bg-surface border border-surface-container hover:border-secondary/50 transition-all cursor-pointer shadow-sm">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-bold text-on-surface">Short Answer</p>
                      <p className="text-[10px] text-on-surface-variant mt-0.5">Conceptual</p>
                    </div>
                  ...
                  <label className="flex items-center p-4 rounded-xl bg-surface border border-surface-container hover:border-tertiary/50 transition-all cursor-pointer shadow-sm">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-bold text-on-surface">Code Lab</p>
                      <p className="text-[10px] text-on-surface-variant mt-0.5">Syntax & Logic</p>
                    </div>
          ...
          <section className="md:col-span-4 space-y-8">
            ...
            <div className="bg-surface border border-surface-container p-6 rounded-2xl relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <div className="flex justify-between items-start mb-6">
                  <span className="bg-primary text-on-primary text-[10px] font-bold px-3 py-1 rounded shadow-sm tracking-widest uppercase">Engine v4.2</span>
                  <span className="flex h-3 w-3 rounded-full bg-green-500 animate-pulse border-2 border-green-200"></span>
                </div>
                <h4 className="font-headline font-bold text-xl text-on-surface mb-1">Learning Model</h4>
                <p className="text-sm text-on-surface-variant mb-8">Neural-Loom Multimodal</p>
                <div className="space-y-4">
                  <div className="flex justify-between items-center text-xs">
                    <span className="font-bold text-on-surface-variant uppercase tracking-wider">Uptime</span>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-surface-container">
              <div className="flex items-center justify-between mb-6">
                <h3 className="font-headline font-bold text-on-surface">AI Templates</h3>
              ...
              <div className="space-y-3">
                <div className="p-4 bg-surface rounded-xl flex items-center gap-4 border border-transparent hover:border-secondary/30 hover:shadow-sm transition-all cursor-pointer">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-bold text-on-surface">STEM Focused</p>
                    <p className="text-[10px] text-on-surface-variant">MCQ + Code Lab</p>
                  </div>
                ...
                <div className="p-4 bg-surface rounded-xl flex items-center gap-4 border border-transparent hover:border-tertiary/30 hover:shadow-sm transition-all cursor-pointer">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-bold text-on-surface">History Drill</p>
                    <p className="text-[10px] text-on-surface-variant">Short Answer Only</p>
                  </div>
                </div>
                ...
                <div className="p-4 bg-surface rounded-xl flex items-center gap-4 border border-transparent hover:border-primary/30 hover:shadow-sm transition-all cursor-pointer">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-bold text-on-surface">Quick Vocab</p>
                    <p className="text-[10px] text-on-surface-variant">Mixed Batch</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="md:col-span-12 grid grid-cols-1 lg:grid-cols-2 gap-8 mt-4">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-surface-container flex items-start gap-6">
              ...
              <div className="flex-1">
                <h5 className="font-headline font-bold text-lg mb-2 text-on-surface">Instant Preview</h5>
                <p className="text-sm text-on-surface-variant leading-relaxed">Generate a sample quiz immediately to test your current parameters without saving them to the global learning model.</p>
                <div className="mt-6">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-surface-container flex items-start gap-6">
              ...
              <div className="flex-1">
                <h5 className="font-headline font-bold text-lg mb-2 text-on-surface">Auto-Scaling</h5>
                <p className="text-sm text-on-surface-variant leading-relaxed">AI automatically adjusts difficulty based on student average performance across learning sets.</p>
