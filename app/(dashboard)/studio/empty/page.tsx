    ...
    <div className="bg-surface text-surface-on min-h-screen">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-xl shadow-sm flex justify-between items-center px-6 h-16 border-b border-surface-container/50">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="h-10 w-10 border-2 border-primary/20 rounded-full bg-surface-container flex items-center justify-center font-bold text-surface-variant">
             A
          </div>
        </div>
      </nav>
      ...
      <aside className="hidden lg:flex flex-col h-screen w-64 fixed left-0 top-0 pt-20 bg-surface-bright border-r border-surface-container pb-6 z-40">
        <div className="px-6 mb-8 mt-6">
          <p className="font-headline text-xl font-bold text-surface-on">Creator Studio</p>
        ...
        <nav className="flex-1 flex flex-col gap-1">
          ...
          <Link href="/studio" className="text-surface-variant px-4 py-3 mx-2 flex items-center gap-3 font-semibold text-sm hover:bg-surface-container rounded-xl transition-all">
        ...
        <section className="w-full max-w-4xl bg-white border border-surface-container rounded-[2rem] overflow-hidden shadow-premium group">
            ...
            <div className="relative h-64 md:h-80 overflow-hidden bg-surface-container flex flex-col items-center justify-center border-b border-surface-container">
                ...
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-20">
                    <span className="material-symbols-outlined text-[120px] text-surface-on shadow-sm">inventory_2</span>
                </div>
            ...
            <div className="p-10 md:p-16 text-center bg-white">
                <h2 className="text-3xl md:text-4xl font-black font-headline text-surface-on mb-4 tracking-tight">No notes uploaded yet</h2>
                <p className="text-surface-variant text-lg max-w-xl mx-auto mb-10 leading-relaxed font-medium">
                ...
                <div className="flex flex-col sm:flex-row gap-5 justify-center mt-4">
                    <button 
                      ...
                      className="bg-primary text-primary-on px-10 py-4 text-lg rounded-full font-bold flex items-center justify-center gap-3 hover:brightness-110 active:scale-95 shadow-md shadow-primary/20 transition-all font-headline"
                    >
                        <span className="material-symbols-outlined">upload_file</span>
                        Upload First PDF
                    </button>
                    <button 
                      className="bg-surface text-surface-on border border-surface-container px-10 py-4 text-lg rounded-full font-bold hover:bg-surface-bright hover:shadow-inner active:scale-95 transition-all font-headline"
                    >
                        Browse Templates
                    </button>
                </div>
            ...
            <div className="bg-surface p-6 border-t border-surface-container flex justify-between items-center px-10">
               <span className="text-xs font-bold text-surface-variant uppercase tracking-widest">Supports .PDF, .TXT, .DOCX</span>
