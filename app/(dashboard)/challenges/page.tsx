...
export default function ChallengesPage() {
  ...
  return (
    <div className="bg-surface text-surface-on min-h-screen">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-xl shadow-sm flex justify-between items-center px-6 h-16">
        <div className="flex items-center gap-8">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <Link href="/history" className="text-surface-variant font-medium font-headline hover:bg-surface-container/50 transition-colors px-3 py-1 rounded-lg">History</Link>
      ...
      <main className="pt-24 pb-12 px-6 lg:ml-64 min-h-screen">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-4">
            <div>
              <span className="inline-block px-3 py-1 bg-secondary-container text-secondary-on text-[10px] font-bold rounded-full mb-3 tracking-widest hidden md:inline-block">SOCIAL ARENA</span>
              <h1 className="text-4xl font-extrabold font-headline tracking-tight text-surface-on">Challenge Your Network</h1>
              <p className="text-surface-variant mt-2 font-medium">Ignite friendly competition and climb the global ranks.</p>
            </div>
            <div className="flex gap-3">
              ...
              <button className="flex items-center gap-2 px-6 py-3 bg-primary text-primary-on font-bold rounded-full shadow-md active:scale-95 transition-transform hover:brightness-110">
            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              <section className="bg-white border border-surface-container rounded-2xl p-8 shadow-sm">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-xl font-bold font-headline flex items-center gap-2 text-surface-on">
                    <span className="material-symbols-outlined text-secondary">person_search</span> Invite a Rival
                  </h2>
                </div>
                <div className="relative mb-6">
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 material-symbols-outlined text-surface-variant">search</span>
                ...
                <div className="space-y-4 max-h-[280px] overflow-y-auto pr-2 no-scrollbar">
                    ...
                    <div key={i} className="flex items-center justify-between p-4 bg-surface rounded-xl hover:bg-surface-bright transition-colors group cursor-pointer border border-surface-container hover:border-primary/30">
                      <div className="flex items-center gap-4">
                        <div className="relative">
                          <div className="w-12 h-12 rounded-full border-2 border-white shadow-sm bg-surface-container flex items-center justify-center text-xs font-bold text-surface-variant">{user.name.charAt(0)}</div>
                          <div className={`absolute bottom-0 right-0 w-3 h-3 ${user.dot} border-2 border-white rounded-full`}></div>
                        </div>
                        <div>
                          <p className="font-bold text-sm text-surface-on">{user.name}</p>
                          <p className="text-[10px] text-surface-variant font-medium">{user.lvl}</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center justify-between p-4 bg-primary/5 rounded-xl border border-primary/20">
                    <div className="flex items-center gap-4">
                      <div className="relative">
                        <div className="w-12 h-12 rounded-full border-2 border-white shadow-sm bg-surface-container flex items-center justify-center text-xs font-bold text-surface-variant">E</div>
                        <div className="absolute bottom-0 right-0 w-3 h-3 bg-green-500 border-2 border-white rounded-full"></div>
                      </div>
                      <div>
                        <p className="font-bold text-sm text-surface-on">Elena Rodriguez</p>
                        <p className="text-[10px] text-surface-variant font-medium">Lvl 31 • 12.4k XP</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                      ...
                      <div className="w-6 h-6 rounded-full bg-primary flex items-center justify-center shadow-sm">
                        <span className="material-symbols-outlined text-xs text-primary-on" style={{ fontVariationSettings: "'FILL' 1" }}>check</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <section className="bg-white border border-surface-container rounded-2xl p-8 shadow-sm">
                <h2 className="text-xl font-bold font-headline mb-6 flex items-center gap-2 text-surface-on">
                ...
                <div className="grid grid-cols-3 gap-4">
                  <button className="p-4 rounded-xl bg-surface border border-surface-container hover:border-secondary/50 transition-all flex flex-col items-center gap-3 group hover:shadow-sm">
                    ...
                    <span className="text-xs font-bold text-surface-on">Cloud Arch</span>
                  </button>
                  ...
                  <button className="p-4 rounded-xl bg-surface border border-surface-container hover:border-secondary/50 transition-all flex flex-col items-center gap-3 group hover:shadow-sm">
                    ...
                    <span className="text-xs font-bold text-surface-on">UX Theory</span>
                  </button>
                  <button className="p-4 rounded-xl bg-surface border border-surface-container hover:border-secondary/50 transition-all flex flex-col items-center gap-3 group hover:shadow-sm">
                    <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform">
                      <span className="material-symbols-outlined text-2xl text-secondary">data_object</span>
                    </div>
                    <span className="text-xs font-bold text-surface-on">JS Patterns</span>
                  </button>
                  <button className="p-4 rounded-xl bg-surface border border-surface-container hover:border-secondary/50 transition-all flex flex-col items-center gap-3 group hover:shadow-sm">
                    <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center shadow-sm group-hover:scale-110 transition-transform">
                      <span className="material-symbols-outlined text-2xl text-secondary">history_edu</span>
                    </div>
                    <span className="text-xs font-bold text-surface-on">History</span>
                  </button>
                  <button className="p-4 rounded-xl bg-surface border border-surface-container hover:border-secondary/50 transition-all flex flex-col items-center gap-3 group hover:shadow-sm">
                    <div className="w-12 h-12 rounded-full bg-surface-container flex items-center justify-center group-hover:scale-110 transition-transform">
                      <span className="material-symbols-outlined text-2xl text-surface-variant">more_horiz</span>
                    </div>
                    <span className="text-xs font-bold text-surface-on">Browse</span>
                  </button>
                </div>
              </section>
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <section className="bg-white border border-surface-container rounded-2xl overflow-hidden shadow-sm">
                <div className="p-6 border-b border-surface-container">
                  <h2 className="text-lg font-bold font-headline flex items-center gap-2 text-surface-on">
                ...
                <div className="divide-y divide-surface-container">
                  <div className="p-6 flex items-center gap-4 hover:bg-surface transition-colors cursor-pointer group">
                    ...
                    <div className="flex-1">
                      <div className="flex justify-between items-center mb-1">
                        <p className="font-bold text-sm text-surface-on">Quantum Physics 101</p>
                      ...
                      <div className="flex items-center gap-2">
                         <span className="text-[10px] text-surface-variant font-medium">vs Sofia Davis</span>
                      </div>
                    </div>
                    <span className="material-symbols-outlined text-surface-variant group-hover:text-primary transition-colors">chevron_right</span>
                  </div>
                  ...
                  <div className="p-6 flex items-center gap-4 hover:bg-surface transition-colors cursor-pointer group">
                    ...
                    <div className="flex-1">
                      <div className="flex justify-between items-center mb-1">
                        <p className="font-bold text-sm text-surface-on">System Design Elite</p>
                        <span className="text-[10px] font-bold text-surface-variant bg-surface-container px-2 py-0.5 rounded uppercase tracking-wider">18h left</span>
                      </div>
                      <div className="flex items-center gap-2">
                         <span className="text-[10px] text-surface-variant font-medium">vs Liam White</span>
                      </div>
                    </div>
                    <span className="material-symbols-outlined text-surface-variant group-hover:text-primary transition-colors">chevron_right</span>
                  </div>
      ...
      <button className="fixed right-6 bottom-24 md:bottom-8 w-14 h-14 bg-secondary text-secondary-on rounded-full flex items-center justify-center shadow-premium active:scale-90 transition-transform z-40 group hover:brightness-110">
