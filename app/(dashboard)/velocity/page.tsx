  ...
  return (
    <div className="bg-surface text-on-surface min-h-screen relative overflow-hidden">
      ...
      <div className="fixed bottom-8 right-8 z-50">
        <button className="w-16 h-16 bg-primary text-on-primary rounded-full shadow-premium flex items-center justify-center hover:scale-110 active:scale-95 transition-all duration-300 group">
      ...
      <aside className="h-screen w-64 fixed left-0 top-0 flex flex-col bg-surface-bright border-r border-surface-container z-40">
        <div className="flex flex-col h-full p-4 gap-2">
          ...
          <div className="px-4 py-6 mb-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <p className="text-[10px] font-bold text-on-surface-variant mt-1 tracking-widest uppercase">System Analytics</p>
              </div>
            </div>
          </div>
          
          <nav className="flex-1 space-y-1">
             <Link href="/dashboard" className="flex items-center gap-3 px-4 py-3 text-on-surface-variant hover:text-primary hover:bg-surface-container rounded-xl font-headline text-sm font-semibold transition-all">
             ...
             <Link href="/leaderboard" className="flex items-center gap-3 px-4 py-3 text-on-surface-variant hover:text-primary hover:bg-surface-container rounded-xl font-headline text-sm font-semibold transition-all">
          ...
          <div className="pt-4 border-t border-surface-container space-y-1">
             <Link href="/settings" className="flex items-center gap-3 px-4 py-3 text-on-surface-variant hover:text-primary hover:bg-surface-container rounded-xl font-headline text-sm font-semibold transition-all">
      ...
      <main className="ml-0 md:ml-64 min-h-screen">
              ...
              <div className="h-8 w-px bg-surface-container mx-2"></div>
               <div className="flex items-center gap-3 pl-2">
                 <div className="text-right hidden sm:block">
                   ...
                   <p className="text-[10px] text-on-surface-variant uppercase tracking-wider font-bold">Lvl {level} Admin</p>
                 </div>
        ...
        <div className="p-8 max-w-[1600px] mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-10">
            <div>
              <h2 className="text-4xl font-extrabold font-headline text-on-surface tracking-tight">Velocity Engine</h2>
              <p className="text-on-surface-variant mt-2 text-lg">Real-time performance metrics and AI generation growth data.</p>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex bg-surface border border-surface-container rounded-full p-1 shadow-inner">
                ...
                <button className="px-5 py-2 text-xs font-bold text-on-surface-variant hover:text-on-surface">24h</button>
                <button className="px-5 py-2 text-xs font-bold text-on-surface-variant hover:text-on-surface">7d</button>
              </div>
              <button className="flex items-center gap-2 bg-primary text-on-primary px-6 py-2.5 rounded-full font-bold text-sm shadow-premium hover:brightness-110 transition-all active:scale-95">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            ...
            <div className="bg-white border border-surface-container p-6 rounded-2xl relative overflow-hidden group hover:shadow-premium hover:border-primary/20 transition-all">
              <div className="relative z-10">
                ...
                <h3 className="text-4xl font-black font-headline text-on-surface">42,892</h3>
                <div className="mt-4 flex items-center gap-2">
                   ...
                   <span className="text-[10px] text-on-surface-variant font-bold">vs last period</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-surface-container p-6 rounded-2xl relative overflow-hidden group hover:shadow-premium hover:border-secondary/20 transition-all">
              <div className="relative z-10">
                ...
                <h3 className="text-4xl font-black font-headline text-on-surface">78.4%</h3>
                <div className="mt-4 flex items-center gap-2">
                   <span className="flex items-center gap-1 text-xs font-bold text-green-600 bg-green-50 px-2.5 py-1 rounded-full border border-green-100">
                     <span className="material-symbols-outlined text-sm">trending_up</span> 3.1%
                   </span>
                   <span className="text-[10px] text-on-surface-variant font-bold">vs average</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-surface-container p-6 rounded-2xl relative overflow-hidden group hover:shadow-premium hover:border-tertiary/20 transition-all">
              <div className="relative z-10">
                ...
                <h3 className="text-4xl font-black font-headline text-on-surface">1.2M</h3>
                <div className="mt-4 flex items-center gap-2">
            ...
            <div className="bg-white border border-surface-container p-6 rounded-2xl relative overflow-hidden group hover:shadow-premium hover:border-primary/20 transition-all">
               <div className="relative z-10">
                 ...
                 <h3 className="text-4xl font-black font-headline text-on-surface">842k</h3>
                 <div className="mt-4 flex items-center gap-2">
                    <span className="flex items-center gap-1 text-xs font-bold text-green-600 bg-green-50 px-2.5 py-1 rounded-full border border-green-100">
                      <span className="material-symbols-outlined text-sm">auto_awesome</span> +8%
                    </span>
                    <span className="text-[10px] text-on-surface-variant font-bold">MoM Growth</span>
                 </div>
               </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 bg-white border border-surface-container rounded-2xl p-8 shadow-sm">
               <div className="flex items-center justify-between mb-8">
                 <div>
                   <h3 className="text-xl font-bold font-headline text-on-surface">Topic Knowledge Index</h3>
                   <p className="text-sm text-on-surface-variant mt-1">Generation volume across categories</p>
                 </div>
                 ...
                 {[
                   ...
                   <div key={i} className="group">
                     <div className="flex items-center justify-between mb-2">
                       <span className="text-sm font-bold text-on-surface font-headline">{stat.name}</span>
                       <span className="text-sm font-bold tracking-widest text-on-surface-variant">{stat.pct}%</span>
                     </div>
            ...
            <div className="bg-white border border-surface-container rounded-2xl p-8 shadow-sm flex flex-col">
               <div className="mb-8">
                 <h3 className="text-xl font-bold font-headline text-on-surface">AI Load Monitor</h3>
                 <p className="text-sm text-on-surface-variant mt-1">Gemini generation wait latency</p>
               </div>
               ...
               <div className="flex-1 flex flex-col justify-center items-center text-center">
                 <div className="relative w-48 h-48 mb-6">
                   ...
                   <div className="absolute inset-0 flex flex-col items-center justify-center rotate-90">
                     <span className="text-5xl font-black font-headline text-on-surface tracking-tighter">0.8s</span>
                 ...
                 <div className="grid grid-cols-2 gap-4 w-full">
                    <div className="bg-surface border border-surface-container p-4 rounded-2xl">
                       <p className="text-[10px] font-bold text-on-surface-variant uppercase mb-1 tracking-widest">Flash API</p>
                       <p className="text-xl font-black font-headline text-on-surface">124<span className="text-sm text-on-surface-variant">req/s</span></p>
                    </div>
                    <div className="bg-surface border border-surface-container p-4 rounded-2xl">
                       <p className="text-[10px] font-bold text-on-surface-variant uppercase mb-1 tracking-widest">Base Latency</p>
                       <p className="text-xl font-black font-headline text-on-surface">42<span className="text-sm text-on-surface-variant">ms</span></p>
                    </div>
                 </div>
               </div>
            </div>
